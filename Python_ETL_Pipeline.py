...
spark= SparkSession.builder.config('spark.jars.packages','com.mysql:mysql-connector-j:8.0.33,com.datastax.spark:spark-cassandra-connector_2.12:3.1.0').getOrCreate()
...
def import_to_mysql(output):
    ...
    .option("url", "jdbc:mysql://localhost:3306/study_de") \
